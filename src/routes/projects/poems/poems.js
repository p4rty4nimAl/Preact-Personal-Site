...
const poems = [
    ...
    },
    {
        ...
        desc: [
            ...
            "The last hundred nights,",
            "Forgotten: repeat the same.",
            "",
            "I could be buried here,",
            "for the times I should've left.",
            "Hoping for something new,",
            "Waiting, again and again,",
            "For something to save me.",
            "",
            "A thousand nights, in the past;",
            "No different to the last,",
            "Nothing changes from within,",
            "A routine becomes unstoppable,",
            "Forcing, demanding, insisting upon itself.",
            "",
            "A day later, in the pouring rain,",
            "Nothing has changed, nothing is new.",
            "The rain the same as it was:",
            "All those years ago.",
            "It meant something then,",
            "Before you sealed yourself away."
        ]
    },
    {
        id: 20,
        ...
        desc: [
            "HE MADE ME FUCKING PARANOID,",
            "PARALYSED WITH FEAR. I DON'T",
            "CARE HOW CORNY OR BASIC THAT",
            "SOUNDS. NOW REALITY CRACKS-,",
            "SHIFTING, ROTATING BELOW ME,",
            "SPINNING OUT FROM UNDERNEATH",
            "WITH HOLES, RIPPING, TEARING",
            "THROUGH. I'LL NEVER FEAR- A,",
            "PLACE, EVENT, ANYTHING QUITE",
            "LIKE THAT AGAIN. I'LL NEVER,",
            "EVER, AGAIN KNOW WHAT IT IS,",
            "WHEN IT'S SAID THAT THEY CAN",
            "'FEEL'. DO NOT COME NEAR ME,",
            "TOUCH ME, KNOW ME. I CANNOT-",
    ...
    },
    {
        ...
        desc: [
            ...
            "no matter how much you've passed it,",
            "gotten over it,",
            "it always creeps, sneaks back in",
            "",
            "at first, unnoticed",
            "blamed on something else, ephemeral symptoms",
            "but then it manifests again.",
            "",
            "exactly as before",
            "as Crushing as ever,",
            "it is- feels Inescapable",
            "no matter the timescale.",
            "",
            "Forever doomed to this existence;",
            "unless I fucking do something about it.",
            "",
            "Soaring, squished, searing.",
            "",
            "As hard as I fight against any meaning",
            "simply my existence must mean something",
            "despite my best efforts I am trapped",
            "'cannot be forgotten",
            "",
            "There is no escape from reality",
            "You are just as doomed to reality",
            "Death cannot protect Us",
            "",
            "No matter how far you come",
            "it will always be right behind you,",
            "waiting. Then",
            "haunting your waking nightmares",
            "stealing your focus",
            "chasing you down",
            "killing You",
            "",
            "It doesn't matter how much you want it;",
            "and how much you don't want it,",
            "it will always be hungry,",
            "you cannot silence that voice",
            "that nagging voice in your head",
            "that will never shut up",
            "until you do -",
            "until you feed it.",
            "",
            "But do I deserve it?",
            ...
            "for the voice does not go away",
            "the only peace I get is in death",
            "",
            "",
    ...
    },
    {
        ...
        desc: [
            ...
            "It was never far, always just",
            "Waiting. Waiting. Quietly,",
            "in the background, tearing away",
            "burning up.",
            "",
            "And it's done with the shielding",
            "it's at your core. Next?",
            "Its time, its world:",
            "you don't get to play any more.",
            "Everything is scripted,",
            "and it will be followed.",
            "",
            "There are actors, but",
            "something is always off;",
            "a mouth that doesn't move,",
            "movement without motion.",
            "",
            "So you turn to the bottle.",
            "Like your father, and his in turn.",
            "It's a wonder it took this long,",
            "you already know addiction.",
            "It works, for a time:",
            "your body obeys you,",
            "your mind does not.",
            "",
            ...
            "of how it ends.",
            "The core shall burn.",
            "Senses shall writhe against you.",
            "The full force of unfeeling shall strike you",
