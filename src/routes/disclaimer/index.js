...
const Disclaimer = () => {
    ...
    <p class={style.disclaimerbody}>
        ...
        There are pages upon this website (xtraea.com) that feature content generated by users. By using this website, you acknowledge the following:<br />
        <ol>
            <li>
        ...
        Beware: external links on this website are not monitored by me, and as such care should be taken when following them.
    </p>
    );
}
